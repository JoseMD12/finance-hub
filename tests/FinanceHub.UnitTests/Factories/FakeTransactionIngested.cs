...
public static class FakeTransactionIngested
{
    ...
    public static TransactionIngested Build(string source = "itau", string? userId = null) => new(
    ...
    public static IEnumerable<TransactionIngested> BuildMany(int count = 5, string source = "itau", string? userId = null) =>
