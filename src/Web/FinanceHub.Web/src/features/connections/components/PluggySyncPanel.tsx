...
import { GlowCard, MagneticButton } from '@/shared/components/motion';
    ...
    <GlowCard glowRgb="224, 86, 151">
      <Card className="flex flex-col gap-3.5 border-slate-200 py-4 px-4 md:px-5">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          ...
          <MagneticButton strength={0.25} className="self-end sm:self-auto">
            <Button
              variant="primary"
              size="sm"
              ...
              className="btn-primary-glow text-xs h-8 whitespace-nowrap"
            >
