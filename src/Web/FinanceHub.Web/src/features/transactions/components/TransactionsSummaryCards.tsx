...
import { SyncInfoModal } from '@/shared/components/SyncInfoModal/SyncInfoModal';
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  aria-label="Entenda os prazos de sincronização bancária"
                  title="Prazos de atualização (Pix vs Cartão)"
                  className="p-0.5 rounded-full text-slate-400 hover:text-brand hover:bg-brand-light transition-colors cursor-pointer"
                >
