      ...
      {isOpen &&
        ...
        ReactDOM.createPortal(
          <div
            ...
            className="z-[9999] w-72 p-3.5 bg-surface-card rounded-2xl shadow-elevated border border-border-subtle flex flex-col gap-3 animate-in fade-in zoom-in-95 duration-150"
          >
